...
export default function Bookmark() {
  ...
  return (
    <div className="min-h-screen w-full overflow-hidden scroll-smooth bg-white font-rubik">
      {/* Header */}
      ...
      <div className="w-full bg-softBlue py-20 text-white">
        <div className="container mx-auto px-4">
          ...
          <div className="mt-8 flex w-full flex-col items-center justify-center space-y-5 lg:flex-row lg:space-x-5 lg:space-y-0">
            ...
            <a
              href="#"
              className="rounded-md bg-softRed px-8 py-2 text-lg uppercase text-white hover:opacity-80 duration-200"
            >
              Contact Us
            </a>
          </div>
      ...
      <div className="w-full bg-veryDarkBlue2 py-10">
        <div className="flex container mx-auto flex-col items-center justify-between md:flex-row px-4">
          <div className="flex flex-col items-center space-y-5 md:flex-row md:space-x-10 md:space-y-0 text-grayishBlue">
            <svg
              width="148"
              height="25"
              xmlns="http://www.w3.org/2000/svg"
            ...
            <a href="#" className="uppercase hover:text-white duration-200 text-lg md:pl-8">features</a>
            <a href="#" className="uppercase hover:text-white duration-200 text-lg">Pricing</a>
            <a href="#" className="uppercase hover:text-white duration-200 text-lg">Contact</a>
          </div>
          <div className="flex items-center space-x-6 mt-6 md:mt-0">
              <img src="public/img/assets/Bookmark/icon-twitter.svg" alt=""  className="cursor-pointer" />
              <img src="public/img/assets/Bookmark/icon-facebook.svg" alt="" className="cursor-pointer"  />
          </div>
        </div>
      </div>
    </div>
