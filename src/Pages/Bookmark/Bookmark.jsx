...
export default function Bookmark() {
  ...
  return (
    <div className="min-h-screen w-full bg-white font-rubik">
      <div className="container mx-auto flex items-center justify-between px-4 py-8">
        <svg width="148" height="25" xmlns="http://www.w3.org/2000/svg" className="z-40">
        ...
        <button
          className={`z-50 block h-8 w-8 cursor-pointer ${!showMenu && "space-y-1.5"} lg:hidden ${showMenu && "-space-y-0.5"} z-40`}
