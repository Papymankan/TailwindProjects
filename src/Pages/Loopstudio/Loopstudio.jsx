...
export default function Loopstudio() {
  return (
    <div className="min-h-screen w-full bg-white">
      {/* Hero */}
      <div className="loopstudio-hero w-full px-6">
        {/* Nav */}
        <div className="flex items-center justify-between pt-8">
          ...
          {/* Nav links */}
          <div className="font-josefin hidden items-center space-x-8 text-lg font-semibold text-white md:flex">
        ...
        <div className="font-josefin mx-auto my-32 max-w-lg border-2 p-4 text-4xl uppercase text-white md:mx-0 md:p-10 md:text-6xl">
